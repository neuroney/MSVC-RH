...
SimpleTimingResult runSingleTest(int t, int m, int d, int secpar) {
    ...
    try {
        ...
        result.maskgen_time = timer.elapsed_ms();
        ...
        timer.start();
        Reconstruct(verification_result, sk_theta, pi, env);
        result.reconstruct_time = timer.elapsed_ms();
...
void MSVC_RH_4_TIMETEST(int t, int m, int d, int secpar, int iterations = 10) {
    std::cout << "=========================================" << std::endl;
    std::cout << "    MSVC_RH_4 Simple Timing Test        " << std::endl;
    std::cout << "=========================================" << std::endl;
    std::cout << std::endl;
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        SimpleTimingResult result = runSingleTest(t, m, d, secpar);
