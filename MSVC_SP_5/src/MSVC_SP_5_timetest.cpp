...
SimpleTimingResult runSingleTest(int d, int m, int t, int secpar)
{
    ...
    result.success = true;
    result.maskgen_time = 0.0;
    result.reconstruct_time = 0.0;
...
TestResultData MSVC_SP_5_TIMETEST(int d, int m, int t, int secpar, int iterations, bool silent)
{
    if (!silent)
    {
        std::cout << "=========================================" << std::endl;
        std::cout << "    MSVC_SP_5 Simple Timing Test        " << std::endl;
        std::cout << "=========================================" << std::endl;
        std::cout << std::endl;
    ...
    // testResult.total_runs = iterations;
